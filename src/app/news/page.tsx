          ...
          <span className='abt uppercase ml-4 text-red-500' data-aos="zoom-in-left">News</span>
            ...
            <div className="image flex col-3 gap-10 justify-between items-center  mt-10 mb-10">
              ...
              <div className="box1 mb-5">
                <Image src="https://marketifythemes.net/html/grax/img/news/1.jpg" alt="News 1" width={350} height={300} className='w-[350px] h-[300px] rounded-lg object-cover hover:opacity-75 hover:blur-[3px] transition-all ease-in-out hover:cursor-pointer' data-aos="fade-right" />
              ...
              <div className="box1 mb-5 ml-32">
                <Image src="https://marketifythemes.net/html/grax/img/news/2.jpg" alt="News 2" width={350} height={300} className='w-[350px] h-[300px] rounded-lg object-cover hover:opacity-75 hover:blur-[3px] transition-all ease-in-out hover:cursor-pointer' data-aos="fade-up" />
              ...
              <div className="box1 mb-5 ml-35">
                <Image src="https://marketifythemes.net/html/grax/img/news/3.jpg" alt="News 3" width={350} height={300} className='w-[350px] h-[300px] rounded-lg object-cover hover:opacity-75 hover:blur-[3px] transition-all ease-in-out hover:cursor-pointer' data-aos="fade-left" />
